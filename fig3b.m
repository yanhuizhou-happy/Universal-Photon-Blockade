...
%N=6;  kappa_a=1;g=0.1;E1=0.01;k=1;ph=0;ph1=0; E2=-E1^2/g; C00=1; 
N=6;  kappa_a=1;g=1;E1=0.05;k=1;ph=0;ph1=0; E2=-E1^2/g; C00=1;   
...
ggg(m)=(((4*(E1^2 + g^2)* k + k^3)^2 + 8* (8 *(2* E1^2 + g^2)^2 + 4 *(3*E1^2 - g^2)*k^2 + ...
 ...
 hold on 
 plot(xx1,log10(abs(ggg)),xx1,log10(abs(p11)))
